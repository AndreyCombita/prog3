...
public class hiloUno extends Thread{
    ...
    public void run(){
        ...
        if(getName().equals("Karen Medina")){
            long ti=System.currentTimeMillis();
for (int j = 0; j < 99; j++) {
                try {
        ...
        if(getName().equals("Andres Urriago")){
            long ti=System.currentTimeMillis();
          for (int j = 0; j < 99; j++) {
                try {
        ...
        if(getName().equals("Andres Galeano")){
            long ti=System.currentTimeMillis();
          for (int j = 0; j < 99; j++) {
                try {
