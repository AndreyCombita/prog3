...
public class carrera {
    ...
    static public void registrarCaballos(){
        ...
        //nombres
        losCaballos[0].setNombre("Kent Miles");
        losCaballos[1].setNombre("Karen Medina");
        losCaballos[2].setNombre("Andres Urriago");
        losCaballos[3].setNombre("Andres Galeano");
        losCaballos[4].setNombre("Kenny Beat");
        //CoordX
